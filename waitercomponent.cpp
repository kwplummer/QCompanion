 ...
 * \details Constructs the component and its dialog, also connects signals used to notify when timers have changed.
 * \param parent
 */
 ...
 * \details Creates a menu that in addition to muting, allows you to choose where to save your timers, and show the dialog to configure timers.
...
/*!
 * \brief Asks the user where they want to store the state file used for the timers.
 */
 ...
 * \details When the user changes a timer this is used to notify the rest of the program that the timers have changed.
 */
