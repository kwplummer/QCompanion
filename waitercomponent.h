 ...
 * \details provides reminders for scheduled events, as well as a GUI to view and modify the events.
 * Notifications are provided one year, one month, one week, one day, 12 hours, 6 hours, one hour, 30 minutes, 15 minutes, 10 minutes, 5 minutes, and one minute before the event. As well as when the event occurs.
 */
...
signals:
    ///\brief Tells the rest of the program that the countdown for next speech should be recalculated.
    void changeTimers();
public:
