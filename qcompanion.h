 ...
 * \details This class organizes all the components, schedules when speaking, notifying, and screenshot-logging will occur.
 */
...
private:
    ...
    QString iconPath;
    ///\brief The tray that stores our menu, the only way to interface with the program.
